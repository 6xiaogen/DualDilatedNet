...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', type=int,help='How many epochs to train', default=2)
    ...
    parser.add_argument('--experiment_version', type=str,help='Experiment Version',default=4)
