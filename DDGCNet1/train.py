...
from models.DDGCNet1_Seg import UseDDGCNet1
from models.DDGCNet1_Seg import DDGCNet1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', type=int,help='How many epochs to train', default=80)
    parser.add_argument('--tb_save_dir', type=str,help='Tensorboard save directory', default='savelog')
    parser.add_argument('--experiment_name', type=str,help='Experiment Name',default='training')
    parser.add_argument('--experiment_version', type=str,help='Experiment Version',default=1)
    ...
    model = get_model()
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=args.train_batch_size,shuffle=True, drop_last=True, num_workers=4)
